	...
	public List<Permission> getPermissionBaseOnHeriarchy(Long herType) throws PortalServiceException {
		...
		try {
			...
			for (PortalSvrUserPermission portalSvrUser : pmDVO) {
				...
				permission.setPermissionId(portalSvrUser.getpId());
				permission.setPermissionName(portalSvrUser.getpName());
				permission.setPermissionType(portalSvrUser.getpType());
				permission.setPermissionDesc(portalSvrUser.getpDescription());
				pmVO.add(permission);
