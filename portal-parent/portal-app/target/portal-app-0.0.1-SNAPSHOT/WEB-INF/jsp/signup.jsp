...
<div id="header"> 
  ...
  <!-- End #subnav --> 
							...
							<form:form action="${contextPath}/doc/signUp/customerSubmit" commandName="signUp">
								...
								<table id="gridNew" width="100%">
									...
									<tr>
										...
										<td><form:input path="password" id="password" type="password" class="txt_width"/></td>
									</tr>
									<tr>
										<td><spring:message code="label.confirmPassword"/>:</td>
										<td><form:input path="confirmPassword" id="confirmPassword" type="password" class="txt_width"/></td>
									</tr>
									<tr>
	...
	<script>
		setTimeout(function() {document.getElementById('firstName').focus();});
	</script>
	<div style="clear: both;"></div>
