				...
				<div class="boxinNew">
					<div class="header" id="collapse" style="overflow: hidden;">
						<h3 style="padding-top:5px;">
							<spring:message code="title.ForgotPassword" />
						</h3>
					...
					<div class="content" id="box1-tabular" style="width:100%!important;">
						<fieldset style="width:100%!important;">
							<div id="msg" class="displayErrMsg" style="color: #0f518e;"><spring:message code="label.ForgotPasswordFormMessage" /></div>
							<c:if test="${Success == '1' }">
								<div id="error" class="displayErrMsg"><spring:message code="label.ForgotPasswordChanged" /></div>
								<script>
									document.getElementById('msg').style.display = 'none';
								</script>
							</c:if>
							<form:form action="${contextPath}/doc/password/forgotSubmit" commandName="forgotPassword">
								<div>
