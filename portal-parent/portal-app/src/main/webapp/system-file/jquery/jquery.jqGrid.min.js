						...
						from : function(f) {
							return new (function(j, i) {
								...
								this.equals = function(n, l, p) {
									return c._compareValues(c.equals, n, l,
											"==", p)
								};
								this.greater = function(n, l, p) {
									return c._compareValues(c.greater, n, l,
											">", p)
								};
								this.less = function(n, l, p) {
									return c._compareValues(c.less, n, l, "<",
											p)
								};
								...
								this.lessOrEquals = function(n, l, p) {
									return c._compareValues(c.lessOrEquals, n,
											l, "<=", p)
								};
								this.startsWith = function(n, l) {
									var p = l === undefined || l === null ? n
											: l;
									p = m ? b.trim(p.toString()).length : p
											.toString().length;
									if (M)
										c._append(c._getStr("this." + n)
												+ ".substr(0,"
												+ p
												+ ") == "
										...
										p = m ? b.trim(l.toString()).length : l
												.toString().length;
								...
								this.orderBy = function(n, l, p, A) {
									l = l === undefined || l === null ? "a" : b
											.trim(l.toString().toLowerCase());
							...
							dragMove : function(d) {
								if (this.resizing) {
									...
									if (h > 33) {
										...
										if (c.forceFit === true) {
											q = this.headers[this.resizing.idx
													+ c.nv];
											g = c.direction === "ltr" ? q.width
													- g : q.width + g;
											if (g > 33) {
												d.newWidth = h;
												q.newWidth = g
							...
							if (this.p.colNames.length !== this.p.colModel.length)
								...
								var J = function(d, g) {
									...
									if (typeof h.formatter !== "undefined") {
										...
										g = b.isFunction(h.formatter) ? h.formatter
												.call(a, g, d, q, o)
												: b.fmatter ? b.fn
														.fmatter(h.formatter,
																g, d, q, o)
									...
									d = l(d, g, h, o, "add");
									return '<td role="gridcell" ' + M(h, q, d)
											+ ">" + d + "</td>"
								}, A = function(d, g, h) {
									d = '<input role="checkbox" type="checkbox" id="jqg_'
											...
											+ a.p.id + "_" + d + '"/>';
									return '<td role="gridcell" ' + M(g, h, "")
											+ ">" + d + "</td>"
								}, t = function(d, g, h, q) {
									h = (parseInt(h, 10) - 1) * parseInt(q, 10)
											+ 1 + g;
									...
									if (b.isXMLDoc(d)) {
										...
										D = (z + "").indexOf("[") === -1 ? U.length ? function(
												da, Z) {
											...
											for (; $ < ga;) {
												...
												if (a.p.grouping) {
													...
													for ( var ya = 0; ya < s; ya++)
														E
																.push(S[a.p.groupingView.groupField[ya]]);
													ia = b(a).jqGrid(
															"groupingPrepare",
															X, E, ia, S);
													X = []
									...
									if (d) {
										...
										(S = b.jgrid.getAccessor(d, g.root))
												|| (S = []);
										W = S.length;
										d = 0;
										...
										if (o)
											oa *= o + 1;
										var $ = b
												.isFunction(a.p.afterInsertRow), ha = {}, ra = "";
										if (a.p.grouping
												&& a.p.groupingView.groupCollapse === true)
										...
										for (; d < W;) {
											...
											if (a.p.grouping) {
												...
												for ( var ia = 0; ia < v; ia++)
													y
															.push(N[a.p.groupingView.groupField[ia]]);
												ha = b(a).jqGrid(
														"groupingPrepare", E,
														y, ha, N);
												E = []
									...
									if (b.isArray(a.p.data)) {
										var C = a.p.grouping ? a.p.groupingView
												: false;
										b
												.each(
														a.p.colModel,
										...
										if (a.p.treeGrid)
											...
											if (d && a.p.sortorder && g)
												a.p.sortorder.toUpperCase() == "DESC" ? s
												...
												.click(
														function() {
															var v = J(a.p.page,
																	1), y = J(
																	a.p.lastpage,
																	1), E = false, I = true, F = true, K = true, z = true;
															if (y === 0
																	|| y === 1)
																z = K = F = I = false;
															else if (y > 1
						...
						this
								.each(function() {
									...
									for ( var T = 0, Y = "", O = {}, fa = b
										...
										if (u) {
											J = t.formatCol(0, 1, "");
											m += '<td role="gridcell" aria-describedby="'
													+ t.p.id
										...
										if (t.rows.length === 0)
											b("table:first", t.grid.bDiv)
													.append(m);
										else
											switch (i) {
											case "last":
												b(t.rows[t.rows.length - 1])
														.after(m);
												break;
											case "first":
												b(t.rows[0]).after(m);
											...
											if (a !== 0) {
																...
																function(l) {
																	if (this.hidden === false
																		...
																		if (!(c < 0)) {
																			...
																			i.grid.headers[l].el.style.width = c
																					+ "px";
																			if (i.p.footerrow)
																				i.grid.footers[l].style.width = c
																						+ "px";
																			if (n)
																				i.grid.cols[l].style.width = c
																						+ "px";
																			m = l
																		}
																	}
												...
												if (r) {
													if (f - G - (e + k * a) !== u)
														M = f - G - (e + k * a)
																- u
												} else if (Math.abs(f - G
														- (e + k * a)) !== 1)
													M = f - G - (e + k * a);
												i.p.colModel[m].width += M;
												i.p.tblwidth = e + M + Q + k
														* J;
												if (i.p.tblwidth > f) {
													r = i.p.tblwidth
															- parseInt(f, 10);
					...
					return this.each(function() {
						...
						if (e.grid) {
							if (isNaN(f))
								...
								k = parseInt(f, 10);
							if (k >= 0) {
								var m = b("tr.ui-jqgrid-labels th:eq(" + k
										+ ")", e.grid.hDiv);
								if (j) {
									var a = b(".s-ico", m);
									b("[id^=jqgh_]", m).empty().html(j).append(
											a);
									e.p.colNames[k] = j
								}
								if (i)
									typeof i === "string" ? b(m).addClass(i)
											: b(m).css(i);
											...
											for (; u < r;) {
												if (b(m.rows[u]).hasClass(
													...
													try {
														...
														e = b.jgrid
																.htmlDecode(m.rows[u].cells[a].innerHTML)
													}
													if (i)
														k += parseFloat(e);
													else if (j)
...
(function(c) {
	...
	c.fmatter.util = {
		...
		DateFormat : function(a, b, d, e) {
			...
			var l = f.getSeconds(), o = f.getMilliseconds(), n = f.getDay(), p = f
				...
				I : "?",
				O : (j > 0 ? "-" : "+")
						+ h(Math.floor(Math.abs(j) / 60) * 100 + Math.abs(j)
								% 60, 4),
				P : "?",
				T : (String(f)
						.match(
	...
	c.fn.fmatter.date = function(a, b, d, e) {
		...
		c.fmatter.isUndefined(b.colModel.formatoptions)
				|| (d = c.extend({}, d, b.colModel.formatoptions));
		return !d.reformatAfterEdit && e == "edit" ? c.fn.fmatter
	...
	c.unformat = function(a, b, d, e) {
		...
		if (typeof j !== "undefined" && c.isFunction(j))
			...
			case "currency":
				...
				break;
			case "checkbox":
				f = b.colModel.editoptions ? b.colModel.editoptions.value
						.split(":") : [ "Yes", "No" ];
		...
		return h ? h : e === true ? c(a).text() : c.jgrid.htmlDecode(c(a)
				.html())
	};
...
var createModal = function(a, b, c, e, f, g) {
	...
	i.id = a.modalhead;
	jQuery(i)
			.append("<span class='ui-jqdialog-title'>" + c.caption + "</span>");
	var j = jQuery(
	...
	jQuery("a.ui-jqdialog-titlebar-close", i)
			.click(
					function() {
						var n = jQuery("#" + a.themodal).data("onClose")
								|| c.onClose, k = jQuery("#" + a.themodal)
								.data("gbox")
								|| c.gbox;
	...
	f = 0;
	if (h && b.left && !g) {
		f = jQuery(c.gbox).width()
				- (!isNaN(c.width) ? parseInt(c.width, 10) : 0) - 8;
	...
	if (jQuery.fn.jqm && b.jqm === true)
		b.jqM ? jQuery(a).attr("aria-hidden", "false").jqm(b).jqmShow()
	...
	function g(k, m) {
		...
		if (m.dataEvents) {
			jQuery.each(m.dataEvents, function() {
				this.data !== undefined ? jQuery(k).bind(this.type, this.data,
						this.fn) : jQuery(k).bind(this.type, this.fn)
			});
			delete m.dataEvents
		}
		return m
		...
		if (typeof b.dataUrl != "undefined")
			...
			if (typeof b.value === "string") {
				...
				for (h = 0; h < e.length; h++) {
					...
					a.innerHTML = f[1];
					if (!j
							&& (jQuery.trim(f[0]) == jQuery.trim(c) || jQuery
									.trim(f[1]) == jQuery.trim(c)))
						a.selected = "selected";
					if (j
							&& (jQuery.inArray(jQuery.trim(f[1]), l) > -1 || jQuery
									.inArray(jQuery.trim(f[0]), l) > -1))
						a.selected = "selected";
					d.appendChild(a)
				}
				...
				for (h in e)
					if (e.hasOwnProperty(h)) {
						...
						a.innerHTML = e[h];
						if (!j
								&& (jQuery.trim(h) == jQuery.trim(c) || jQuery
										.trim(e[h]) == jQuery.trim(c)))
							a.selected = "selected";
						if (j
	...
	case "custom":
		...
		try {
			...
			n == "e2" ? info_dialog(jQuery.jgrid.errors.errcap,
					...
					jQuery.jgrid.errors.errcap, typeof n === "string" ? n
							: n.message, jQuery.jgrid.edit.bClose)
		}
		break
	}
	return d
	...
	if (e) {
		...
		if (e.date === true)
			if (!(f === false && isEmpty(a))) {
				...
				if (!checkDate(b, a))
					return [ false,
							g + ": " + jQuery.jgrid.edit.msg.date + " - " + b,
							"" ]
			}
		if (e.time === true)
			if (!(f === false && isEmpty(a)))
				...
				searchGrid : function(f) {
					...
					return this
							.each(function() {
								...
								function B(m) {
									m = m && m.hasOwnProperty("reload") ? m.reload
											: true;
									var q = a("#" + w.p.id), A = {};
									q[0].p.search = false;
									if (f.multipleSearch === false)
										...
										if (a("#" + i).html() != null) {
											...
											if (n.length > 0) {
												...
												f.multipleSearch === true
														...
														&& b(w, f);
												a
														.isFunction(f.onInitializeSearch)
														&& f
																.onInitializeSearch(a("#"
																		+ i));
												a
														.isFunction(f.beforeShowSearch)
														&& f
																.beforeShowSearch(a("#"
																		+ i));
												C();
				...
				editGridRow : function(f, b) {
					...
					return this
							.each(function() {
												...
												.extend(
														{
															...
															type : d.mtype,
															data : a
																	.isFunction(d.serializeEditData) ? d
																	.serializeEditData(c)
																	: c,
															complete : function(
																	J, y) {
								...
								function E() {
									var e = a(g).jqGrid("getDataIDs"), r = a(
											"#id_g", "#" + j).val();
									return [ a.inArray(r, e), e ]
								}
								var g = this;
								if (g.grid && f) {
									var k = g.p.id, h = "FrmGrid_" + k, j = "TblGrid_"
											+ k, l = {
										themodal : "editmod" + k,
										modalhead : "edithd" + k,
										...
										scrollelm : h
											...
											: false, Q = a
											.isFunction(d.afterShowForm) ? d.afterShowForm
											: false, m = a
											.isFunction(d.beforeInitData) ? d.beforeInitData
											: false, q = a
											.isFunction(d.onInitializeForm) ? d.onInitializeForm
									...
									if (a("#" + l.themodal).html() != null) {
										...
										var P = isNaN(b.dataheight) ? b.dataheight
												: b.dataheight + "px";
										P = a(
										...
										P = a("<span></span>").append(P)
												.append(D);
										createModal(l, P, b,
												"#gview_" + g.p.id, a("#gbox_"
														+ g.p.id)[0]);
										if (m) {
											a("#pData, #nData", "#" + j + "_2")
													.css("float", "right");
				...
				viewGridRow : function(f, b) {
					...
					return this
							.each(function() {
								...
								function w() {
									var c = a(i).jqGrid("getDataIDs"), u = a(
											"#id_g", "#" + g).val();
								...
								if (i.grid && f) {
									...
									var n = i.p.id, E = "ViewGrid_" + n, g = "ViewTbl_"
											+ n, k = {
										themodal : "viewmod" + n,
										modalhead : "viewhd" + n,
									...
									if (a("#" + k.themodal).html() != null) {
										...
										var l = isNaN(b.dataheight) ? b.dataheight
												: b.dataheight + "px", s = a("<form name='FormPost' id='"
												+ E
																...
																.extend(
																		{
																			...
																			data : b
																					.isFunction(a.p.serializeSubGridData) ? a.p
	...
	f.jgrid
			.extend({
				...
				groupingToggle : function(b) {
					this
							.each(function() {
								var c = this.p.groupingView, a = b
										.lastIndexOf("_"), d = b.substring(0,
										a + 1);
								a = parseInt(b.substring(a + 1), 10) + 1;
								var e = c.minusicon, g = c.plusicon;
								if (f("#" + b + " span").hasClass(e)) {
									c.showSummaryOnHide && c.groupSummary[0] ? f(
											"#" + b).nextUntil(".jqfoot")
											.hide()
											: f("#" + b).nextUntil(
													"#" + d + String(a)).hide();
									f("#" + b + " span").removeClass(e)
											.addClass(g)
								} else {
									f("#" + b).nextUntil("#" + d + String(a))
											.show();
									f("#" + b + " span").removeClass(g)
											.addClass(e)
								}
							});
					return false
								...
								if (a.grid && a.p.treeGrid) {
									...
									if (b[k] == "true" || b[k] === true) {
										...
										if (b[e] == "true" || b[e] === true) {
											i += a.p.treeIcons.minus
													+ " tree-minus treeclick'";
											b[e] = true
										} else {
											i += a.p.treeIcons.plus
													+ " tree-plus treeclick'";
											b[e] = false
										}
										b[k] = false
								...
								if (a.grid && a.p.treeGrid)
									...
									case "nested":
										var f = a.p.treeReader.left_field, e = a.p.treeReader.right_field, k = a.p.treeReader.level_field, j = parseInt(
												b[f], 10), i = parseInt(b[e],
												10), h = parseInt(b[k], 10);
										d(this.p.data)
												.each(
														function() {
															if (parseInt(
								...
								if (a.grid && a.p.treeGrid)
									...
									case "nested":
										var e = a.p.treeReader.left_field, k = a.p.treeReader.right_field, j = a.p.treeReader.level_field, i = parseInt(
												b[e], 10), h = parseInt(b[k],
												10), g = parseInt(b[j], 10);
										d(this.p.data)
												.each(
														function() {
															parseInt(this[j],
					...
					return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (k = g.length; e < k; e++) {
								j = g[e];
								i.push(j);
								d(this).jqGrid("collectChildrenSortTree", i, j,
										b, c, a, f)
							}
							d.each(i, function(l) {
								...
								if (l === 0) {
									...
									d("td", l).each(
											function(n) {
												d(this).css(
														"width",
														h.grid.headers[n].width
																+ "px")
											});
									h.grid.cols = l[0].cells
								}
								d("tbody", h.grid.bDiv).append(
										d("#" + m, h.grid.bDiv))
							});
							i = g = e = null
						}
					...
					return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (i = g.length; j < i; j++) {
								h = g[j];
								b.push(h);
								d(this).jqGrid("collectChildrenSortTree", b, h,
										a, f, e, k)
							}
						}
					})
					...
					if (!a("#colchooser_" + g[0].p.id).length) {
						...
						b = a.extend({
							...
							apply_perm : function() {
								a("option", e).each(
										function() {
											this.selected ? g.jqGrid("showCol",
													h[this.value].name) : g
													.jqGrid("hideCol",
															h[this.value].name)
										});
						...
						var h = g.jqGrid("getGridParam", "colModel"), i = g
						...
						var n = a.isFunction(b.dlog_opts) ? b.dlog_opts.call(g,
								b) : b.dlog_opts;
						c(b.dlog, d, n);
